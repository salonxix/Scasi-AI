            ...
            <div className="mm-root">
                ...
                <div className="mm-shell">
                    ...
                    <aside className="mm-sidebar">
                        ...
                        <div className="mm-ai" onClick={() => onNavigate("work")} style={{ cursor: "pointer" }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" /><line x1="7" y1="7" x2="7.01" y2="7" /></svg>Work <span className="mm-aidot" style={{ background: "#7c3aed", marginLeft: "auto" }}></span></div>
                        <div className="mm-ai" onClick={() => onNavigate("finance")} style={{ cursor: "pointer" }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" /><line x1="7" y1="7" x2="7.01" y2="7" /></svg>Finance <span className="mm-aidot" style={{ background: "#34d399", marginLeft: "auto" }}></span></div>
                        <div className="mm-ai" onClick={() => onNavigate("personal")} style={{ cursor: "pointer" }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" /><line x1="7" y1="7" x2="7.01" y2="7" /></svg>Personal <span className="mm-aidot" style={{ background: "#fbbf24", marginLeft: "auto" }}></span></div>
